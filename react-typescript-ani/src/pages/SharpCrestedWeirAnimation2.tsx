...
const SharpCrestedWeirAnimation2: React.FC = () => {
  ...
  const [gaugePositions, setGaugePositions] = useState<number[]>([0.5, 0.75]);
  ...
  }, [leftWaterLevel, rightWaterLevel, waterPresent, waterPosition, flowSpeed, isPaused, numberOfGauges, gaugePositions]);
...
export default SharpCrestedWeirAnimation2;