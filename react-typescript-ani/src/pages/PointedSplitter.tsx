...
const PointedSplitter: React.FC = () => {



    // Component for Venturi Flow Animation
      const [h2, setH2] = useState<number>(25); // State to manage water height
      ...
      return (
        <div className="w-full max-w-3xl mx-auto p-4 border rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4">Pointed Splitter Flow Animation</h2>
...
export default PointedSplitter;