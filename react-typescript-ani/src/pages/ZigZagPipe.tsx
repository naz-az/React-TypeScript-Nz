        ...
        <svg width="100%" height="120px" viewBox="0 0 400 120" className="mb-6">
          ...
          <linearGradient id="waterGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#3498db">
              <animate attributeName="stop-color" values="#3498db; #2ecc71; #3498db" dur="4s" repeatCount="indefinite" />
            </stop>
            <stop offset="100%" stopColor="#2ecc71">
              <animate attributeName="stop-color" values="#2ecc71; #3498db; #2ecc71" dur="4s" repeatCount="indefinite" />
            </stop>
          </linearGradient>
        </svg>
